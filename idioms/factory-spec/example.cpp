...
class Farm : public Building {
 public:
  explicit Farm(const FarmSpec& spec)
      : with_pasture_(spec.with_pasture_),
        number_of_stalls_(spec.number_of_stalls_) {}
...
class Forge : public Building {
 public:
  explicit Forge(const ForgeSpec& spec)
      : magic_forge_(spec.magic_forge_),
        number_of_apprentices_(spec.number_of_apprentices_) {}
